...
if ($context->customer->isLogged())
{
	...
	if (Tools::file_exists_cache(_PS_THEME_DIR_.'modules/jmswishlist/jmswishlist-ajax.tpl'))
		$context->smarty->display(_PS_THEME_DIR_.'modules/jmswishlist/jmswishlist-ajax.tpl');
	elseif (Tools::file_exists_cache(dirname(__FILE__).'/jmswishlist-ajax.tpl'))
		$context->smarty->display(dirname(__FILE__).'/jmswishlist-ajax.tpl');
	else
