...
class JmsWishListViewModuleFrontController extends ModuleFrontController
{
	...
	public function __construct()
	{
		...
		include_once($this->module->getLocalPath().'jmswishlist.php');
	}
	...
	public function initContent()
	{
		...
		$this->setTemplate('module:jmswishlist/views/templates/front/view.tpl');
	}
}
