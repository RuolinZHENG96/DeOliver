...
class AdminJmsblogSettingController extends ModuleAdminController
{
    ...
    public function renderSettingForm()
    {
		...
		$postlayouts = JmsBlogHelper::getFiles('post-layout');
		$categorieslayouts = JmsBlogHelper::getFiles('categories-layout');
		$categorylayouts = JmsBlogHelper::getFiles('category-layout');
        ...
        $this->fields_options[0]['form'] = array(
            'tinymce' => true,
            'tabs' => array('general' => 'General', 'layout' => 'Layout', 'image' => 'Image', 'comment' => 'Comment', 'social' => 'Social Sharing'),
