		...
		{foreach from=$posts item=post}
			...
			<div class="item col-sm-6 col-md-6 col-lg-6 col-xs-12">
                   ...
                   <div class="top-info">
					...
					{if $jmsblog_setting.JMSBLOG_SHOW_CATEGORY}
						<li class="post-category">
								<a href="{jmsblog::getPageLink('jmsblog-category', $catparams)}">{l s='Category:' d='Modules.JmsBlog'}
		            ...
		            <li class="post-created">
						...
						<span>{$post.created|escape:'html':'UTF-8'|date_format:"%Y"}</span></li>
					 ...
					 {if $jmsblog_setting.JMSBLOG_SHOW_COMMENTS}
							<li class="post-comments"><i class="fa fa-comments-o" aria-hidden="true"></i><span>{l s='Comments' d='Modules.JmsBlog'} :</span> {$post.comment_count|escape:'html':'UTF-8'}</li>
							{/if}
				</div>
			</ul>
				<div class="post-intro">
						...
						<a class="btn btn-default blog-readmore button-small" href="{jmsblog::getPageLink('jmsblog-post', $params)}">{l s='Read more' d='Modules.JmsBlog'}</a>
					</div>
