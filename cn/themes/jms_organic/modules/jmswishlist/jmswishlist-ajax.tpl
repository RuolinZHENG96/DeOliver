...
{if $products}
	...
	{foreach from=$products item=product name=i}
		<dt class="{if $smarty.foreach.i.first}first_item{elseif $smarty.foreach.i.last}last_item{else}item{/if}">
			...
			<a class="ajax_cart_block_remove_link" href="javascript:;" onclick="javascript:WishlistCart('wishlist_block_list', 'delete', '{$product.id_product}', {$product.id_product_attribute}, '0');" title="{l s='remove this product from my wishlist' d='Shop.Theme.Global'}" rel="nofollow"><img src="icon/delete.gif" width="12" height="12" alt="{l s='Delete' d='Shop.Theme.Global'}" class="icon" /></a>
		</dt>
