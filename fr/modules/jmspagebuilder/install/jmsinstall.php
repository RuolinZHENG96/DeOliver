...
class JmsPageBuilderInstall
{
    ...
    {
        $home1_id = $this->_addHomePage('OrganicShop - Home 1', 'organicshop_home_1.txt', 0, '', '', 'home_1');
		Configuration::updateValue('JPB_HOMEPAGE', $home1_id);
		$home2_id = $this->_addHomePage('OrganicShop - Home 2', 'organicshop_home_2.txt', 1, '', '', 'home_2');
		$home3_id = $this->_addHomePage('OrganicShop - Home 3', 'organicshop_home_3.txt', 2, '', '', 'home_3');
    }
}
