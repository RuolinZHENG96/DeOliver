...
{block name='content'}
  ...
  <section id="main" itemscope itemtype="https://schema.org/Product">
        ...
        <div class="pb-right-column">
         ...
         {/block}
          {block name='product_description_short'}
              <div id="product-description-short-{$product.id}" itemprop="description" class="product-desc">{$product.description_short nofilter}</div>
            {/block}
	...
	<div id="more_info_block" class="tabs col-xs-12 col-sm-12 col-md-6 col-lg-12">
    ...
    {block name='product_accessories'}
      ...
      <div class="row accessories">
        <section class="product-accessories clearfix controlstyle2">
      <div class="addon-title">
        <h3>{l s='Accessories' d='Shop.Theme.Catalog'}</h3>
      </div>
      <div class=" accessories-carousel customs-carousel-product"> 
