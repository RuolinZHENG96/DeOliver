...
class JmsCustomhtmlLeft extends Module
{
    ...
    {
        $return = true;
        $html_demo = '<div class="html_left jms-banner"><a href="#"><img class="img-responsive" src="themes/jms_organic/assets/img/demo/customhtml.jpg" alt="Banner HTML" /></a>
<div class="banner-content">
<div class="banner-box">
<div class="box-content">
<p>Juice Beauty Product</p>
<h4>Organic Skin</h4>
